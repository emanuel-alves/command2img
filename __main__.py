...
if __name__ == "__main__":
    PROGRAM_NAME=argv[0]    
    parser = argparse.ArgumentParser(description="Turns a text input into an image.", 
        epilog=f'example:\ttree | {PROGRAM_NAME}\n\t\tcat file.txt | {PROGRAM_NAME}\n\t\techo "my image" | {PROGRAM_NAME}',
    ...
    if not stdin.isatty():
        ...
        parser.error('It is necessary to receive an input through the pipe. example: tree | command2img.')
