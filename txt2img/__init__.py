...
def Txt2img(text:str, margin=10, font_face=FONT_FACE_MESLO, font_size=28, font_encoding="unic", backgroud=(255,255,255), text_fill=(0,0,0)) -> Image:
    
    font = ImageFont.truetype(font=font_face, 
                          size=font_size, 
